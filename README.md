# IFRS17 Business Service Layer — Skeleton (Branch: `Skeleton_v1.9`)
...
├── docs/IFRS17-BSL-기능정의서_v1.0.xlsx  # 기능정의서 Excel 상세판 (WBS·오류코드·테스트케이스·진척)
├── docs/IFRS17-BSL-기능정의서_v1.1.xlsx  # 기능정의서 Excel 간단판 (4.3 표준 처리 순서 13단계)
├── docs/IFRS17-BSL-기능정의서_v1.2.xlsx  # 기능정의서 Excel (13단계 + 기능별 세부 처리 단계 81건)
├── docs/IFRS17BSL기능정의서_v2.0.xlsx    # 기능정의서 v2.0 — 기능 단위 요약본
├── docs/IFRS17BSL기능정의서_v2.1.xlsx    # 기능정의서 v2.1 — 표 간결화 + 10번 항목 상세 (현행 기준본)
...
| `Skeleton_v1.4` | Skeleton 구현본 v1.4 — 기능정의서 WBS 상세화 및 Excel 판 추가 |
| `Skeleton_v1.5` | Skeleton 구현본 v1.5 — 기능정의서 간단판(v1.1) 추가 |
| `Skeleton_v1.6` | Skeleton 구현본 v1.6 — 기능정의서 v1.2 (기능별 세부 처리 단계) 추가 |
| `Skeleton_v1.7` | Skeleton 구현본 v1.7 — 기능정의서 v1.2 BSL-F-10 상세화 · 설계서 근거 열 추가 |
| `Skeleton_v1.8` | Skeleton 구현본 v1.8 — 기능정의서 v2.0 신규 작성 (기능 단위 요약본) |
| `Skeleton_v1.9` | Skeleton 구현본 v1.9 — 기능정의서 v2.1 (표 간결화 · 10번 항목 상세) (본 브랜치) |
| `Skeleton_v2.0`, `v2.1`, ... | 이후 Skeleton 개선·보완 시 버전을 올려 신규 브랜치로 관리한다. |
