# IFRS17 Business Service Layer — Skeleton (Branch: `Skeleton_v1.8`)
...
├── docs/IFRS17BSL기능정의서_v2.0.xlsx    # 기능정의서 v2.0 — 기능 단위 요약본 (현행 기준본)
...
| `Skeleton_v1.8` | Skeleton 구현본 v1.8 — 기능정의서 v2.0 신규 작성 (기능 단위 요약본) (본 브랜치) |
| `Skeleton_v1.9`, `v2.0`, ... | 이후 Skeleton 개선·보완 시 버전을 올려 신규 브랜치로 관리한다. |
