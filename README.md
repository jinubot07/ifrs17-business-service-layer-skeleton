# IFRS17 Business Service Layer — Skeleton (Branch: `Skeleton_v1.7`)
...
| `Skeleton_v1.7` | Skeleton 구현본 v1.7 — 기능정의서 v1.2 BSL-F-10 상세화 · 설계서 근거 열 추가 (본 브랜치) |
| `Skeleton_v1.8`, `v1.9`, ... | 이후 Skeleton 개선·보완 시 버전을 올려 신규 브랜치로 관리한다. |
