# IFRS17 Business Service Layer — Skeleton (Branch: `Skeleton_v1.6`)
...
├── docs/IFRS17-BSL-기능정의서_v1.2.xlsx  # 기능정의서 Excel (13단계 + 기능별 세부 처리 단계 71건)
...
| `Skeleton_v1.6` | Skeleton 구현본 v1.6 — 기능정의서 v1.2 (기능별 세부 처리 단계) 추가 (본 브랜치) |
| `Skeleton_v1.7`, `v1.8`, ... | 이후 Skeleton 개선·보완 시 버전을 올려 신규 브랜치로 관리한다. |
